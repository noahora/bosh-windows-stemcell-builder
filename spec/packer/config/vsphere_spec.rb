      ...
      it 'returns the expected provisioners' do
        ...
        expect(provisioners).to eq(
          [
            ...
            {"type"=>"powershell", "inline"=>TRAP_ERRORS + ["Get-Log"]},
        ...
        it 'returns the expected provisioners' do
          ...
          expected_provisioners_except_lgpo =
            [
              ...
              {"type"=>"powershell", "inline"=>TRAP_ERRORS + ["Install-Agent -IaaS vsphere -agentZipPath 'C:\\provision\\agent.zip'"]},
              ...
              {"type"=>"powershell", "inline"=>TRAP_ERRORS + ["Optimize-Disk"]},
              {"type"=>"powershell", "inline"=>TRAP_ERRORS + ["Compress-Disk"]},
              {"type"=>"powershell", "inline"=>TRAP_ERRORS + ["Clear-Provisioner"]},
            ].flatten
