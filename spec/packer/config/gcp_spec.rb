      ...
      it 'returns the expected provisioners' do
        ...
        expect(provisioners).to eq(
          [
            ...
            {"type"=>"powershell", "inline"=>TRAP_ERRORS + ["Install-Agent -IaaS gcp -agentZipPath 'C:\\provision\\agent.zip'"]},
            ...
            {"type"=>"powershell", "inline"=>TRAP_ERRORS + ["Invoke-Sysprep -IaaS gcp -OsVersion windows2012R2"]}
          ].flatten
        )
      end
    end
